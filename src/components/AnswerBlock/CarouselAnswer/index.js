                    ...
                    <div className="carousel-container">
                        {
                            this.props.answer.items.map(
                                (item, index) => (<CarouselItem editing={this.props.editing} item={item} index={index} setItem={this.setItem} key={index} delete={() => this.deleteItem(index)} deleteCarousel={this.props.delete} />)
                            )
                        }
                        {
                            this.props.editing &&
