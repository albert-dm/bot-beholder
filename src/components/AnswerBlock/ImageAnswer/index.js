                        ...
                        if (this.props.editing) {
                            return (
                                <div className="wrap">
                                    ...
                                    <p><b>Título:</b> <input onChange={this.handleItemChange} type='text' name="title" value={this.props.answer.items[0].title} /></p>
                                    <p><b>Subtítulo:</b><textarea onChange={this.handleItemChange} name="subtitle" value={this.props.answer.items[0].subtitle} /></p>
                                    <p><b>URL:</b> <input onChange={this.handleItemChange} type='text' name="url" value={this.props.answer.items[0].url} /></p>
                                </div>
                            )
                        } else {
                            return (
