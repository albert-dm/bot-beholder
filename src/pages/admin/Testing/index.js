                    ...
                    <ReactCSSTransitionGroup
                        ...
                        transitionLeaveTimeout={200}>
                        {
                            this.state.blocks.map((block, index) =>
                                <Block selected={index === this.state.selected} block={block} onClick={() => this.selectBlock(index)} key={block.id} deleteBlock={(e) => { e.stopPropagation(); this.deleteBlock(index); }} />
                            )
                        }
                    </ReactCSSTransitionGroup>
                </FlowDisplay>
